package ir.vebko.www.vebkoarremoteassistance.vuforia;
...
import ir.vebko.www.vebkoarremoteassistance.SampleAppMenu.SampleAppMenu;
import ir.vebko.www.vebkoarremoteassistance.SampleAppMenu.SampleAppMenuGroup;
import ir.vebko.www.vebkoarremoteassistance.SampleAppMenu.SampleAppMenuInterface;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.SampleApplicationControl;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.SampleApplicationException;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.SampleApplicationSession;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.utils.LoadingDialogHandler;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.utils.SampleApplicationGLView;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.utils.Texture;
...
//        vuforiaAppSession.initAR(this, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        mMovieName[STONES] = "VideoPlayback/koli02.mp4";
        mMovieName[CHIPS] = "VideoPlayback/koli02.mp4";
        ...
        mGestureDetector.setOnDoubleTapListener(new OnDoubleTapListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                Log.d("testttttttt", "onSingleTapConfirmed: " + "   ddddddddddddddd");
...
//        simpleSeekBar = (SeekBar) mUILayout.findViewById(R.id.seekBar); // initiate the Seek bar
//        simpleSeekBar.setProgress(0);
        ...
        this.runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                if (mVideoPlayerHelper != null && mVideoPlayerHelper.length > 0) {
                    if (seekBarFlag && mVideoPlayerHelper[1].getDuration() > 0) {
//                        simpleSeekBar.setMax(mVideoPlayerHelper[1].getDuration());
                        seekBarFlag = false;
                    }
                    if (isSeekChange) {
                        if (mVideoPlayerHelper[1].isPlaying()) {
//                            simpleSeekBar.setProgress(mVideoPlayerHelper[1].getCurrentPosition());
                        }
                    }
                }
...
//                if (!isSeekChange) {
//                    mVideoPlayerHelper[1].seekTo(seekBar.getProgress());
//                }
//            }
//
...
//                isSeekChange = true;
//                if (mVideoPlayerHelper != null && mVideoPlayerHelper[1].isPlaying()) {
//                    mVideoPlayerHelper[1].pause();
//                    mVideoPlayerHelper[1].play(false, seekBar.getProgress());
//                }
//            }
//        });
...
//            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    ...
    private void startLoadingAnimation() {
        mUILayout = (ConstraintLayout) View.inflate(this, R.layout.camera_overlay, null);
        ...
        mUILayout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                Log.d("jjjj", "onTouch: " + event.getX() + "      :     " + event.getY());
                return false;
            }
        });
    ...
    public boolean doLoadTrackersData() {
        ...
        // TODO: 2019-11-09
        // Load the data sets:
        if (!dataSetStonesAndChips.load("s.xml", STORAGE_TYPE.STORAGE_APPRESOURCE)) {
        ...
        Log.d("salaaaaaaaam", "doLoadTrackersData: " + numTrackables);
