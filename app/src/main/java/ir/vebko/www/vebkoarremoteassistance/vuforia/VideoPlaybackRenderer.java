...
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.utils.SampleMath;
import ir.vebko.www.vebkoarremoteassistance.SampleApplication.utils.SampleUtils;
...
public class VideoPlaybackRenderer implements GLSurfaceView.Renderer
{
    ...
    void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            // TODO: 2019-11-09
//            Log.d("arash33", "renderFrame: " + mVideoPlayerHelper[1].getCurrentPosition());
            // image targert detect
