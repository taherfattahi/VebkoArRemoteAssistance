...
public class ArSceneView extends SceneView implements VideoSink {
    ...
    public ArSceneView(Context context) {
        ...
        eglRenderer = new SurfaceEglRenderer(getResourceName());
...
//        eglRenderer.init(this.getContext(), this.getDrawableState());
    }
    ...
    public void init(final EglBase.Context sharedContext,
        ...
        eglRenderer.init(sharedContext, this.rendererEvents /* rendererEvents */, configAttributes, drawer);
    }
}
