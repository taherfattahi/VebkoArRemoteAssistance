...
//    public static final int VIDEO_RESOLUTION_HEIGHT = 720;
    ...
    private void createLocalStream() {
        ...
        if (videoEnable) {
            ...
            captureAndroid.startCapture(VIDEO_RESOLUTION_WIDTH, VIDEO_RESOLUTION_HEIGHT, FPS, null);
//            captureAndroid.startCapture1(VIDEO_RESOLUTION_WIDTH, VIDEO_RESOLUTION_HEIGHT, FPS);
...
//        }
    ...
    private class Peer implements SdpObserver, PeerConnection.Observer {
        ...
        public void onSetSuccess() {
            Log.v(TAG, "sdp        " + pc.signalingState().toString());
